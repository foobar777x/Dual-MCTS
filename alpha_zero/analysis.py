...
def plot_elo(ax, x, data, data_col, normalized=True):
  ...
  for index, row in df.iterrows():
    ...
    p1_alpha = 10**((Ra - m) / 400)
    p2_alpha = 10**((Rb - m) / 400)

    print(p1_alpha, p2_alpha)

    df.at[index, "P1_alpharank"] = p1_alpha / (p1_alpha + p2_alpha)
    df.at[index, "P2_alpharank"] = p2_alpha / (p1_alpha + p2_alpha)
